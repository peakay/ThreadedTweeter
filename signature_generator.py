...
if __name__ == '__main__':
    ...
    keys = {
        "twitter_consumer_secret": 'K4DVg78s5CT87SEdQKt2PacFfwiIDQykmrEMJRyxiK19f4hHya',
        "twitter_consumer_key": 'MOWyzHz9ocvopxX5CG58JD4Mj',
        "access_token": "2904469139-UJNiN9oufOQegioExxDvS9YVlx5NdGRcN5CxCdE",
        "access_token_secret": "SY4T5tnXjer7N8YOtlVA4sxJ1UCcbowzoyslVY9syuuPL"
    }
    ...
    r_2 = requests.get(url, headers=headers)

    print(json.dumps(json.loads(r_2.text), sort_keys=False, indent=4))
    print(headers)
